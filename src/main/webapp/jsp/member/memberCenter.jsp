...
<head>
    ...
    <script type="text/javascript" src="/templete/fore/wx/front/js/global.js?sdf"></script>
    ...
    <link rel="stylesheet" href="/templete/fore/wx/front/css/global.css?22123s34">

    <link rel="stylesheet" href="/templete/fore/commonfront/css/color/green.css?22sd1sdf123123s34">
...
<div id="ucorder" class="clickLink" data-href="/user/order/order">
...
<div id="uc_list">
    ...
    <div class="uc_node box clickLink" id="uc_infomng" data-href="/user/idcards">
...
<div id="bottom">驿町微客房(www.yiding.me)</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#uc_order").actionSheet({
            "buttons":[{name:'日租房',url:'/user/order/dayOrders' } ,
                {name:'钟点房',url:'/user/order/hourOrders'}
            ] ,
            "cancelText":"取消"
        }) ;
